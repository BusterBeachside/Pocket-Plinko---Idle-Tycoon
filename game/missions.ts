...
export const DAILY_MISSIONS: Mission[] = [
    ...
    { id: 'baskets_daily', name: 'Basket Master', description: 'Land 50,000 balls in baskets today', target: 50000, stat: 'baskets', reward: { moneyMultiplier: 15 } },
    { id: 'bonus_marbles_daily', name: 'Bonus Catcher', description: 'Catch 25 Bonus Marbles today', target: 25, stat: 'bonus_marbles', reward: { moneyMultiplier: 25 } },
    { id: 'upgrades_bought_daily', name: 'Big Spender', description: 'Buy 500 upgrades today', target: 500, stat: 'upgrades_bought', reward: { moneyMultiplier: 15 } },
...
export const REPEATABLE_MISSIONS: Mission[] = [
    ...
    { id: 'baskets_rep', name: 'Quick Baskets', description: 'Land 5,000 balls in baskets', target: 5000, stat: 'baskets', reward: { moneyMultiplier: 1.5 } },
    { id: 'bonus_marbles_rep', name: 'Quick Catcher', description: 'Catch 5 Bonus Marbles', target: 5, stat: 'bonus_marbles', reward: { moneyMultiplier: 2.5 } },
